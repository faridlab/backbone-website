//! Specifications for Visitor aggregate
//!
...
// Each predicate implements `Specification<Visitor>` and can be combined
...
//
// pub struct ActiveVisitorSpec;
// impl Specification<Visitor> for ActiveVisitorSpec {
//     fn is_satisfied_by(&self, e: &Visitor) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
