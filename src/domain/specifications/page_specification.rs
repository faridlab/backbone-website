//! Specifications for Page aggregate
//!
...
// Each predicate implements `Specification<Page>` and can be combined
...
//
// pub struct ActivePageSpec;
// impl Specification<Page> for ActivePageSpec {
//     fn is_satisfied_by(&self, e: &Page) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
