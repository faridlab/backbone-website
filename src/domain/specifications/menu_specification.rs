//! Specifications for Menu aggregate
//!
...
// Each predicate implements `Specification<Menu>` and can be combined
...
//
// pub struct ActiveMenuSpec;
// impl Specification<Menu> for ActiveMenuSpec {
//     fn is_satisfied_by(&self, e: &Menu) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
