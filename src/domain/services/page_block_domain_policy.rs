//! Domain policy for PageBlock aggregate
//!
...
/// Domain policy for PageBlock — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<PageBlock>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type PageBlockDomainPolicy = PermitAllPolicy<PageBlock>;
