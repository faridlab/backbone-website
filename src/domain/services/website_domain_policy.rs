//! Domain policy for Website aggregate
//!
...
/// Domain policy for Website — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Website>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type WebsiteDomainPolicy = PermitAllPolicy<Website>;
